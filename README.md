...
| Crate          | Contents                                                                                                                                                                                                                                                                                     |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `eqn-core`     | `Set` and `Subset`, `BinaryOperator`, the law markers (`Associative`, `Commutative`, `Identity`, `Inverse`), `Map`, `Symbol`, the `Expression` / `Rewriter` traits every tree implements, and `Quotient`, a quotient by an `Equivalence` or a `NormalForm`. Concrete sets `N`, `Z`, `Q`, `R`.  |
